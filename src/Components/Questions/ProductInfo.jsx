...
const ProductInfo = () => {
  return (
    <div className=' w-11/12 h-auto flex flex-col gap-6'>
    <div>
    ...
    <div className=' flex flex-col text-center font-semibold gap-4'>
        ...
        <input type="text" className=' h-10 border-black rounded-lg px-5 font-medium focus:border-primary outline-none border-2 ' />
    </div>
    ...
    <div className=" flex justify-between">
        ...
        <button className=' px-6 sm:px-12 py-3 bg-primary text-white font-bold rounded-xl'>
            Next
        </button>
    </div>
