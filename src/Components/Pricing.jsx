...
const Pricing = () => {
  return (
    <div>
  <main className="grid grid-cols-1 items-center  sm:flex-row justify-center">
    
    <div className=" flex flex-col items-center justify-center">
      <h1 className="text-3xl sm:text-5xl font-bold mb-6 text-left sm:text-center"><span className="text-indigo-600">Eliminate Guesswork </span> and Save Time
      </h1>
